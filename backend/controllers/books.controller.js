...
export const borrowBook = async (req, res) => {
  ...
  try {
    ...
    if (book.section !== librarian.section) {
      return res.status(400).json({
        message: `Librarian is not assigned to the '${book.section}' section.`,
      });
    }
    ...
    await saveJsonToTxtFile("borrowed_books.json", borrowedBooks);
