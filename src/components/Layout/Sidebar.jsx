  ...
  return (
    <div className="p-4 border-b border-slate-300">
      <div className="flex items-center gap-2">
        <div
          className={`flex items-center justify-center w-10 h-10 rounded-md bg-indigo-600 flex-shrink-0`}
        >
          <svg
            width="24"
            height="24"
        ...
        {open && (
          ...
          >
            <span className="font-semibold text-slate-700">TomIsLoading</span>
